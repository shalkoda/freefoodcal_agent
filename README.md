...
Pastel-themed dashboard with dark mode toggle, real-time scan progress, analytics, and one-click OAuth for Google Calendar and Microsoft Outlook.

📖 **[Full UI breakdown + screenshots → WEB_INTERFACE.md](WEB_INTERFACE.md)**
